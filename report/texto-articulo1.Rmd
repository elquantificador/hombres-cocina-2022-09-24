...
En el siguiente repositorio de [GitHub](https://github.com/christianjaviersalasmarquez/Articulo1_LIDE), podrás revisar el código, encontrar los cálculos y reproducir el análisis.
